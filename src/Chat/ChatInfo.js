...
function ChatInfo({
    ...
    return (
        ...
        <div
            id="rightsidebar"
            className={" bg-white absolute z-20 top-0 bottom-0 w-full md:w-80 xl:w-96 md:static md:top-auto md:bottom-auto md:translate-x-0 transform transition-transform duration-200 ease-in-out border-0 md:border-l border-gray-200"
                ...
                <div className="p-2">
                    <div className="flex text-gray-400 hover:text-gray-500">
                        <button className="flex w-full justify-between items-center outline-none focus:outline-none" >
                            <div className="text-md font-medium text-base text-gray-600">Media Link and Documents</div>
