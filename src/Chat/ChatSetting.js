...
function ChatSetting({
    ...
    return (
        <div>
            <div
                id="sidebar"
                className={"flex flex-col absolute z-40 left-0 top-0 w-full h-screen no-scrollbar  bg-gray-100  duration-200 ease-in-out " + (openSetting ? "translate-x-0" : "-translate-x-full")}
            >
