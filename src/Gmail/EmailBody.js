...
function EmailBody({
    ...
    const handleMessageDelete = () => {
        ...
        deleteMessage('me', message.result.id).then(() => {
            onDeleteSuccess();
        });
                    ...
                    <span className="flex items-center overflow-hidden">
                        ...
                        <div className="w-full overflow-hidden">
                            <div className="flex items-center">
                                <span className="block font-bold text-base text-gray-600 dark:text-white">
                                    {messageTitle}
                                </span>
                            </div>
                            <span className="block text-sm text-gray-600 dark:text-slate-400 truncate overflow-hidden">
